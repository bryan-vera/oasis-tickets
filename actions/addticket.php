<?php	
	...
	if (empty($_POST['title'])) {
		...
		$sql = mysqli_query($con, "select id_soporte from tckt_categoria where id_categoria=$category_id");
		if($c=mysqli_fetch_array($sql)) {
			$id_user_asignado=$c['id_soporte'];
		}
		...
		$sql="insert into tckt_ticket_principal (titulo,descripcion,id_tipo,id_status,
			id_categoria,id_user_crea_ticket,id_departamento,updated_at,created_at, 
			id_user_asignado) 
			value (\"$title\",\"$description\",$tipo_id, $status_id,
			$category_id,$user_id,$departamento_id,\"$created_at\",
			\"$created_at\",$id_user_asignado)";
