            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="projects.php"><i class="fa fa-briefcase"></i> Departamentos</a>
                    </li>
                    ...
                    <li class="<?php if(isset($active7)){echo $active7;}?>">
                        <a href="status.php"><i class="fa fa-stethoscope"></i> Status</a>
                    </li>

                    <li class="<?php if(isset($active8)){echo $active8;}?>">
                        <a href="tipos.php"><i class="fa fa-dot-circle-o"></i> Tipos</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <img src="assets/images/profiles/1.png" alt=""><?php echo $name;?>
                            <span class=" fa fa-angle-down"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="dashboard.php"><i class="fa fa-user"></i> Mi cuenta</a></li>
                            <li><a href="actions/logout.php"><i class="fa fa-sign-out pull-right"></i> Cerrar Sesión</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
